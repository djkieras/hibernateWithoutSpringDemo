 ...
 *******************************************************************************/
package net.davekieras.hwsd.test.config;
...
import net.davekieras.hwsd.config.ApplicationProperties;
...
public final class ApplicationConfigUnpooled {

	private static final Logger LOG = LoggerFactory.getLogger(ApplicationConfigUnpooled.class);
	private volatile Boolean loaded = Boolean.FALSE;

	private ApplicationConfigUnpooled() {
	}

	private static class LazyHolder {
		static final ApplicationConfigUnpooled INSTANCE = new ApplicationConfigUnpooled();
	}

	public static ApplicationConfigUnpooled getInstance() {
	...
	private final IDataTypeFactory newDbUnitDatatypeFactory() {
		IDataTypeFactory factory = new H2DataTypeFactory();
		FactoryRegistry.getInstance().register(IDataTypeFactory.class, factory);
		return factory;
	}
