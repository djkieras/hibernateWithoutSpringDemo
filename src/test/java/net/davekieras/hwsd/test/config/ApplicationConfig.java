...
public final class ApplicationConfig {
	...
	private final EntityManagerFactory newEntityManagerFactory() {
		LOG.info("Loading entityManagerFactory...");

		PersistenceUnitInfo persistenceUnitInfo = newPersistenceUnitInfo("PersistenceName", null);
		Map<String, Object> configuration = new HashMap<>();
		configuration.put(AvailableSettings.INTERCEPTOR, interceptor());

		EntityManagerFactoryBuilderImpl factoryBuilder = new EntityManagerFactoryBuilderImpl(
				new PersistenceUnitInfoDescriptor(persistenceUnitInfo), configuration);
		EntityManagerFactory factory = factoryBuilder.build();
